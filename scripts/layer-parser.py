...
active_releases = [e['release_codename'].lower() for e in releases if e['series'] !='full']
...
for layer in parsed_layers:
    ...
    if len(maintainers) == 1:
        ...
        print(maintainers)
        parsed_layers[layer]['maintainers'] = '{} and {}'.format(', '.join(maintainers[:-1]), maintainers[-1])
